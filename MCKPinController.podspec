...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/MacKaSL/MCKPinController.git', :tag => "1.0.4.12" }
  # s.source       = { :path => '.' }
  ...
  # s.resources = ['MCKPinController/Assets.xcassets/*']
   ...
   s.ios.resource_bundle = { 'MCKPinController' => 'MCKPinController/Assets.xcassets/**/*.{json,png}' }
